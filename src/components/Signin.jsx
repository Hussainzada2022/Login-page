          ...
          <div className='bg-slate-800 border border-slate-600 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-20 relative'>
              ...
              <form action="">
                  <div className='relative my-4'>
                      ...
                      <label htmlFor="" className='absolute peer-focus:-top-3 top-3 hidden peer-focus:flex peer-placeholder-shown:opacity-100 '>User name</label>
                  </div>
                  <div className='relative my-4'>
                      ...
                      <label htmlFor="" className='absolute peer-focus:-top-3 top-3 hidden peer-focus:flex peer-placeholder-shown:opacity-100 '>Your password</label>
                  </div>
                  <button className='mb-4 text-[18px] mt-6 rounded bg-blue-500 py-2 hover:bg-blue-600 transition-colors duration-300 w-full px-2'>Login</button>
              </form>
          </div>
      </div>
    )
